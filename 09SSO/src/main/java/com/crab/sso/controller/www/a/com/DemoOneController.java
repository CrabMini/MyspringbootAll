package com.crab.sso.controller.www.a.com;

import com.crab.sso.controller.www.x.com.LoginCheck;
import com.crab.sso.util.HttpUtils;
import com.crab.sso.util.RespMessage;
...
public class DemoOneController {
    ...
    public ModelAndView demo1(HttpServletRequest request) {
        ...
        if (cookies != null && cookies.length > 0) {
            ...
            for (Cookie cookie : cookies) {
                if (LoginCheck.COOKIE_NAME.equals(cookie.getName())) {
                    // 向校验服务器发送校验请求
                    String url = "http://x.com:8080/sso/checkCookie";
        ...
        mv.addObject("path", "a");
        mv.addObject("gotoUrl", "http://a.com:8080/a/demo1");
    ...
    public RespMessage doLogin(@RequestParam Map<String, String> param) {
        // 向校验服务器发送校验请求
        String url = "http://x.com:8080/sso/doLogin";
