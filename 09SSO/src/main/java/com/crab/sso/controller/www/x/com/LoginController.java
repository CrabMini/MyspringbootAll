package com.crab.sso.controller.www.x.com;
...
public class LoginController {
    ...
    public RespMessage doLogin(String username, String password) {
        ...
        if (ok) {
            ...
            Map<String, String> targetCookieA = this.buildCookieMap("http://a.com:8080/a/addCookie");

            // 向www.b.com服务器发送增加cookie
            Map<String, String> targetCookieB = this.buildCookieMap("http://b.com:8080/b/addCookie");
